...
<div class="bg-gray-800 h-screen w-full relative overflow-hidden">
  ...
  <div class="relative z-20 flex flex-col items-center justify-center gap-6 h-screen w-full">
    ...
    <div class="flex md:flex-row gap-32 flex-col">
      <div class="group relative rounded-full overflow-hidden">
        ...
        <a href="/about" class="relative inline-block rounded-full bg-pink-400 px-14 py-2 hover:bg-pink-600 transition-colors duration-1000 z-20 ">&lt;About Me&gt;</a>
      </div>
      <div class="group relative rounded-full overflow-hidden">
        <span class="pointer-events-none absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent -translate-x-full opacity-0 group-hover:animate-flash z-30 duration-1000"></span>
